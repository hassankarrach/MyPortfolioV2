  ...
  return (
    <StyledContainer data-scroll-section id="Works">
      <div className="DevContainer Section">
        <DevWorkCard
          prv={Project4}
          title="Conveasy - Realtime chat app"
          desc="Realtime chat app using Socket.io, NextJs/NodeJs."
          techs={Conveasy}
          preview="https://conveasy-client.vercel.app/"
          sourceCode="https://github.com/hassankarrach/Conveasy"
        />
        <DevWorkCard
          prv={Project1}
          title="Wydad Website"
          desc="wydad athletic club's unofficial website."
          techs={Wydad}
          preview="https://wydad-ac-website.vercel.app/"
          sourceCode="https://github.com/hassankarrach/Wydad-AC-Website"
        />
        <DevWorkCard
          prv={Project2}
          gif={Project2Gif}
          preview="https://www.abundeez.com"
          sourceCode="https://github.com/hassankarrach/Web-3-NFT-Dapp"
          title="Abundeez - NFT minting website"
          desc="Nft minting website for Abundeez collection on the Ethereum blockchain."
          techs={abundeez}
        />
        <DevWorkCard
          prv={Project3}
          ...
          preview="/"
          title="Portfolio"
          sourceCode="https://github.com/hassankarrach/MyPortfolio"
          desc="My Personal Portfolio V2.0"
          techs={Portfolio}
        />
          ...
          {filtered.map((item) => {
            return (
              <motion.div
                ...
                alt="design work"
                key={item.id}
                style={{ backgroundImage: `url(${item.Prv})` }}
                onClick={() => {
                  setIsOpen(true);
        ...
        <div className="FreelanceHolder ">
          <div className="Freelance">
            ...
            <div className="FreelanceContent">
              <h2 className="title">more works here :</h2>
      ...
      <div className="DevTitle">
        <h1 ref={WorksTitle}>Featured works</h1>
      </div>

      <div className="GraphicDesignTitle">
        <h1 ref={GDWorksTitle}>Last works</h1>
      </div>
    </StyledContainer>
  );
}
  ...
  .DesignContainer {
    ...
    .MobileFilter {
      ...
      background: linear-gradient(
        0deg,
        rgba(245, 240, 236, 0.31416316526610644) 0%,
    ...
    .FreelanceHolder {
      ...
      .Freelance {
        ...
        .FreelanceContent {
          ...
          background: linear-gradient(
              90deg,
              rgba(16, 16, 26, 0.92) 0%,
              rgba(16, 16, 26, 0.92)
            ),
            url("https://images.unsplash.com/photo-1616588589676-62b3bd4ff6d2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Z2FtaW5nJTIwc2V0dXB8ZW58MHx8MHx8&w=1000&q=80");
          flex-direction: column;
          color: white;
...
const DevWorkCard = ({
  ...
  return (
    <StyledDevWorkCard prv={prv} gif={gif} className="DevWorkItemAnimate">
      <div className="LeftDevWorkCard"></div>
        ...
        <div className="Buttons">
          ...
          <a className="linkBut" href={sourceCode} target="_blank">
            <button
              ...
              className={disabled ? `disabled` : ""}
            >
              Source code <FaGithub className="InnerIcons" />
            </button>
          </a>
        </div>
      </div>
