...
//Media
import Cover from '../../../Media/Header/Cover.jpg';
  ...
  return (
    ...
    <div className="Left">
      ...
      <div className="Right" ref={HeaderContainerImg}>
        <img height='100%' width='auto' className='HeaderCover' src={Cover} title='Hassan karrach photo' alt='hassan karrach photo'/>
        <div className='IconHolder'>
       <img width='180px' height='180px' src={SpinText} className='spinText' ref={SpinRef} title='hassan karrach logo' alt='hassan karrach logo'/>
